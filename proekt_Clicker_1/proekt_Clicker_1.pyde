...
b = 0
def setup():
    global a,img,f, b, clicks, img2, buy2, xDif2, yDif2, last_time,interval,cps,img3
    size(600,400)
    a = SoundFile(this,"ll.mp3")
    f = SoundFile(this,"up.mp3")
...
def draw():
    background(255)
    global a,img,f, b, clicks, img2, buy, buy2, xDif2, yDif2, last_time,interval,cps,r,g,b,img3
    ...
    text(buy2,525,270)
    textSize(20)
    text("Cpc/Per click:",66,10)
    if buy > 3699:
        fill(255,0,0)
    else:
        fill(0)
    text(click,167,10) #Cpc/Per click
    fill(0)
    text("Cps/Per second:",80,30)
    if buy2 > 3699:
        fill(255,0,0)
    else:
        fill(0)
    ...
    b = random(1,255)
def mouseClicked():
    global f,clicks,xDif,yDif,click,buy, buy2, xDif2, yDif2, last_time,interval,cps
    fill(0)
    a.play()
    xDif = 500 - mouseX
    yDif = 100 - mouseY
